...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/bs4-m-p.css') }}">
                                    ...
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                ...
                                                <p>
                                                    This is your temporary password: <b>{{ $password }}</b> for the sample system. Login with your email address.
                                                </p>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block powered-by">
                                        {{-- Powered by <a href="#">Caimitoapps.</a> --}}
                                    </td>
                                </tr>
                            </table>
                        </div>
